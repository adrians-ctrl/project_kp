<?php $__env->startSection('title', ($profil?->nama_sekolah ?? 'SDN Babakan 02') . ' — Beranda'); ?>
        ...
        <div class="relative mx-auto max-w-4xl px-4 text-center lg:px-6">
            <?php if($profil?->akreditasi): ?>
                <span class="inline-flex items-center gap-1.5 rounded-full bg-white/15 px-4 py-1.5 text-xs font-medium text-white mb-5">
                    ...
                    Terakreditasi <?php echo e($profil->akreditasi); ?>
            ...
            <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
                <a href="<?php echo e(route('landing.berita')); ?>"
                ...
                <a href="<?php echo e(route('landing.kontak')); ?>"
                ...
                <div class="grid grid-cols-2 gap-6 sm:grid-cols-4">
                    ...
                    <?php $__currentLoopData = $infoItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-center">
                            <p class="font-display text-lg font-bold text-[var(--primary)]"><?php echo e($item['value']); ?></p>
                            <p class="mt-0.5 text-xs uppercase tracking-wide text-[var(--muted-foreground)]"><?php echo e($item['label']); ?></p>
                        </div>
            ...
            <div class="mx-auto max-w-5xl px-4 lg:px-6">
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    <div class="rounded-2xl border border-[var(--border)] bg-[var(--primary-soft)] p-8">
                        ...
                        <p class="text-sm text-[var(--muted-foreground)] leading-relaxed"><?php echo e($visiMisi->visi); ?></p>
                    </div>
                    ...
                    <div class="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-8">
                        ...
                        <ul class="space-y-2 text-sm text-[var(--muted-foreground)] leading-relaxed">
                            <?php $__currentLoopData = preg_split('/\r\n|\r|\n/', trim($visiMisi->misi)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $poin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(trim($poin) !== ''): ?>
                                    <li class="flex items-start gap-2">
                                        ...
                                        <span><?php echo e(ltrim($poin, '0123456789. ')); ?></span>
                                    </li>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
            ...
            <div class="mx-auto max-w-4xl px-4 lg:px-6">
                <div class="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-8 lg:p-10">
                    ...
                    <p class="text-sm text-[var(--foreground)] leading-relaxed whitespace-pre-line">
                        <?php echo e($profil->sambutan); ?>

                    </p>
                    <?php $kepsek = $guru->firstWhere('jabatan', 'Kepala Sekolah'); ?>
                    <?php if($kepsek): ?>
                        <div class="mt-6 flex items-center gap-3 border-t border-[var(--border)] pt-5">
                            <img src="<?php echo e($kepsek->foto_url); ?>" alt="<?php echo e($kepsek->nama_lengkap); ?>"
                                 class="h-12 w-12 rounded-full object-cover ring-2 ring-[var(--border)]">
                            <div>
                                <p class="text-sm font-semibold text-[var(--foreground)]"><?php echo e($kepsek->nama_lengkap); ?></p>
                ...
                <div class="grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-4">
                    <?php $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex flex-col items-center text-center rounded-xl border border-[var(--border)]
                            ...
                            <img src="<?php echo e($item->foto_url); ?>" alt="<?php echo e($item->nama_lengkap); ?>"
                            ...
                            <p class="mt-1 text-xs text-[var(--muted-foreground)]"><?php echo e($item->jabatan); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        ...
        <section class="py-16 lg:py-20" x-data="{ lightbox: null }">
            <div class="mx-auto max-w-6xl px-4 lg:px-6">
                <div class="flex items-end justify-between mb-10">
                    ...
                    <a href="<?php echo e(route('landing.galeri')); ?>"
                       class="hidden sm:inline-flex items-center gap-1 text-sm font-medium text-[var(--primary)] hover:underline">
                        Lihat semua
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5"/>
                ...
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
                    <?php $__currentLoopData = $galeri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button @click="lightbox = { url: '<?php echo e($item->foto_url); ?>', judul: <?php echo \Illuminate\Support\Js::from($item->judul)->toHtml() ?> }"
                                class="group aspect-square overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--muted)]">
                            <img src="<?php echo e($item->foto_url); ?>" alt="<?php echo e($item->judul); ?>"
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Users\mr015\OneDrive\Dokumen\File Kampus\project_kp-main\project_kp\resources\views/landing/index.blade.php ENDPATH**/ ?>