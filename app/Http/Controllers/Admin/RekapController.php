...
class RekapController extends Controller
{
    ...
    {
        return view('coming-soon', ['title' => 'Rekap Nilai']);
    }

    public function absensi(): View
    {
        return view('coming-soon', ['title' => 'Rekap Absensi']);
    }

    public function rapor($id): View
    {
        return view('coming-soon', ['title' => 'Rapor']);
    }

    public function getByKelas($kelas): JsonResponse
    {
        return response()->json([]);
    }

    public function resetPassword(Request $request, $user): RedirectResponse
    {
        return back();
    }
}