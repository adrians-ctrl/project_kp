...
@section('content')
    ...
    <x-ui.page-header
        ...
        desc="Ringkasan kehadiran seluruh siswa pada tanggal tertentu."
    ...
    {{-- Filter --}}
    <x-ui.section-card>
        <form method="GET" action="{{ route('admin.absensi.rekap-harian') }}">
    ...
    >
        ...
        @if ($absensi->isEmpty())
            <x-ui.empty-state
                ...
                message="Belum ada absensi yang tercatat untuk tanggal dan filter yang dipilih."
            />
        @else
