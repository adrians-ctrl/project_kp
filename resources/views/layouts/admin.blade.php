...
<head>
    ...
    <title>@yield('title', 'Dashboard') — UPTD SD Negeri Babakan 02</title>
            ...
            <div class="shrink-0 border-t border-[var(--sidebar-border)] p-3">
                <div class="flex items-center gap-3 rounded-md px-3 py-2.5 overflow-hidden">
                    ...
                    <div class="min-w-0 flex-1 overflow-hidden" :class="{'hidden': !sidebarOpen && !isMobile}">
                        ...
                        <div class="truncate text-[11px] text-[var(--sidebar-foreground)]/60">Administrator</div>
                    </div>
                </div>
        ...
        function layoutAdmin() {
            return {
                ...
                toggleSidebar() {
                    ...
                    if (!this.isMobile) localStorage.setItem('sidebarOpen', this.sidebarOpen);
                }
            }
        }
    </script>
